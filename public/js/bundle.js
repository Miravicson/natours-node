    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); // setting true forces reload from the server.
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWlyYXZpY3NvbiIsImEiOiJja2pybTRycGwzZ3AxMnpxb3JyeGtsempjIn0.xsVU0KNyzr--qpE2WR8-HA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/miravicson/ckjthwfcv0czv19mwqidz65kz',
    scrollZoom: false // center: [-118.113491, 34.111745], // [lng, lat]
    // zoom: 10,
    // interactive: false,
          ...
          case 0:
            ...
            if (type === 'password') {
              ...
              onSuccess = function onSuccess() {
                (0, _alerts.showAlert)('success', 'You have updated your password.');
              };
            } // Type is data
            ...
            if (type === 'data') {
              ...
              onSuccess = function onSuccess() {
                (0, _alerts.showAlert)('success', 'You updated your profile details');
                window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./login":"login.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51I9fQ5E1eb9BdB71MgGl2gQKsjzfgmo8XYcJ0zZjUtoCLz3vnXk1LOU7JiHTTPxnQymXPrQXYkczH8muH7fjy2H800fThAtNV0');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Error booking tour');
...
var updateUserForm = document.querySelector('#updateUserData');
var updateUserPasswordForm = document.querySelector('#updateUserPassword');
